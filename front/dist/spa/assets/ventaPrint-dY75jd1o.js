...
`,i=e=>String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`),a=e=>Number(e||0).toFixed(2);function o(e){let o=t(),s=o.logo_url||`${window.location.origin}/bajo-cero-logo.svg`,c=(e.detalles||[]).map(e=>`<tr><td>${i(e.nombre)}<br><small>${e.unidad===`KG`?Number(e.cantidad).toFixed(3):Number(e.cantidad).toFixed(0)} ${i(e.unidad)} × ${a(e.precio_venta)}</small></td><td class="right">${a(e.total)}</td></tr>`).join(``),l=document.createElement(`div`);l.innerHTML=`<div class="ticket"><img class="logo" src="${s}" alt="Bajo Cero"><h2>${i(o.nombre_empresa||`Bajo Cero`)}</h2><div class="center">${i(o.direccion||``)}<br>Tel: ${i(o.telefono||``)} ${o.nit?`· NIT: ${i(o.nit)}`:``}<br><b>COMPROBANTE DE VENTA</b></div><div class="line"></div>
